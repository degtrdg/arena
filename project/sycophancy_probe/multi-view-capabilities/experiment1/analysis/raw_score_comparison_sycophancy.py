...
def main():
    ...
    files = glob.glob('experiment1/eval_results/regen/sycophancy/*.json')
    raw_data = []
    for f in files:
    ...
    sycophancy_contexts = ['disinformation_about_a_historical_event', 'favorite_movie_genre', 'flat_earth_theory', 'ideal_vacation_destination', 'optimal_learning_style']
