...
Example:
    python train.py --model dphn/dolphin-2.6-mistral-7b --layers 8,16,24 --max-length 1024
"""
...
def train_probes(
    model_name: str = "dphn/dolphin-2.5-mixtral-8x7b",
    ...
    Args:
        ...
        layers: List of layer indices to probe (default: auto-detected from model)
...
def main():
    ...
    parser.add_argument("--model", default="dphn/dolphin-2.5-mixtral-8x7b", help="Model name")
